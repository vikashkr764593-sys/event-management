...
@section('content')
    ...
    <div class="space-y-6">
        <x-common.component-card title="Users">
            <div class="mb-4">
                <a href="{{ route('admin.users.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition">Add New</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2 border">
                                <a href="{{ route('admin.users.edit', $item->id) }}" class="text-blue-500 hover:underline">Edit</a>
