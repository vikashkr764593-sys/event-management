            ...
            <div class="p-6">
                <div class="space-y-4">
                    @forelse($notifications as $notification)
                        <div class="flex items-start gap-4 p-4 rounded-xl border {{ $notification->is_read ? 'border-gray-100 bg-white dark:border-gray-800 dark:bg-transparent' : 'border-brand-100 bg-brand-50/30 dark:border-brand-500/20 dark:bg-brand-500/5' }} transition-all">
                            <div class="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full {{ $notification->is_read ? 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400' : 'bg-brand-100 text-brand-600 dark:bg-brand-500/20 dark:text-brand-400' }}">
